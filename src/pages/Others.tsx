  ...
  return (
    <Box sx={{ 
      ...
      >
        ...
        >
          Generate UTM links for other tracking purposes. Enter the URL and select the client, campaign, source, 
          and source type. You can add new campaigns and source types as needed. The UTM parameters will be 
          automatically generated to track performance.
        </Typography>
          ...
          >
            ...
            <Box>
              <FormControl fullWidth>
                ...
                >
                  {availableSourceTypes.filter(type => type.source === formData.source).map((type) => (
      ...
      >
        ...
        <DialogContent>
          ...
          <TextField
            ...
            helperText="2-3 letters, e.g., OTH for other, EM for email"
            sx={{
              mt: 2,
              '& .MuiOutlinedInput-root': {
                '& fieldset': {
      ...
      <UTMLinkList department="others" reloadTrigger={reloadTrigger} />
    </Box>
  );
};
